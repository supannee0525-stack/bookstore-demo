...
CATEGORIES = [
    "นวนิยาย", "วรรณกรรมไทยร่วมสมัย", "วรรณกรรมแปล", "เรื่องสั้น", "นิยายวาย",
    "จิตวิทยา/พัฒนาตนเอง", "ธรรมะ/ศาสนา", "ปรัชญา",
    "โหราศาสตร์/ดูดวง",
    "ธุรกิจ/การเงิน", "ประวัติศาสตร์", "ชีวประวัติ",
    "การเมือง/สังคม", "สารคดี/ความรู้ทั่วไป",
...
CHAT_PROMPT_STAFF = (
    ...
    # เขียนเป็นตัวอย่างประโยคให้ลอกได้เลย เพราะเคยเจอโมเดลลอกคำสั่งออกมาตอบตรงๆ
    # (ตอบว่า "ไม่มีแล้วหยุด" ซึ่งเป็นคำสั่ง ไม่ใช่คำตอบ)
    "- ถ้าค้นไม่เจอ ให้ตอบสั้นๆ ว่า 'ไม่มีเล่มนี้ในร้านครับ' เท่านั้น "
    "ห้ามต่อท้ายว่าเจอกี่เล่มหรือให้ไปดูการ์ด\n"
